...
## tmp locations
nhis_data <- read.csv(file.path("..", "Projects", "IPUMS", "ipumsED", "data", "nhis_sample.csv"))
ipums_data <- read.csv(file.path("..", "Projects", "IPUMS", "ipumsED", "data", "ipumsi_sample.csv"))
## this is very wrong
# ipums_ddi <- readRDS(file.path("..", "Projects", "IPUMS","ipumsED","data","ipumsi_ddi.rda"))

# 
# ## UPDATE
# nhis_data <- read.csv(file.path("..", "ipumsED", "data", "nhis_sample.csv"))
# ipums_data <- read.csv(file.path("..", "ipumsED", "data", "ipumsi_sample.csv"))
# ## this is very wrong
# ipums_ddi <- readRDS(file.path("..","ipumsED","data","ipumsi_ddi.rda"))
