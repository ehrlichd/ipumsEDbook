...
One last bit of definitions: **POSIT** is a new name/re brand of the company that produces the RStudio software. In the past, the RStudio (company) produced the RStudio (software).
