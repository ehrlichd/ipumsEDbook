...
\addcontentsline{toc}{chapter}{Hello Anthropologists!!}
...
\addcontentsline{toc}{chapter}{AAA ``In-Class'' Results}

\hypertarget{load-the-data}{%
\subsection*{Load the Data}\label{load-the-data}}
\addcontentsline{toc}{subsection}{Load the Data}
...
\addcontentsline{toc}{section}{Access the Data}
...
\addcontentsline{toc}{subsection}{Mode Code}
...
\addcontentsline{toc}{subsection}{Mode Results}
...
\addcontentsline{toc}{subsection}{Continuous Data - Boxplots}
...
\addcontentsline{toc}{subsection}{Continuous Data - Histograms}
...
\addcontentsline{toc}{section}{Load the Data}
...
\addcontentsline{toc}{chapter}{Access the Data}
...
\addcontentsline{toc}{chapter}{Summarize Data}

\hypertarget{continuous-data-1}{%
\section*{Continuous Data}\label{continuous-data-1}}
\addcontentsline{toc}{section}{Continuous Data}
...
\addcontentsline{toc}{section}{All in summary()}
...
\addcontentsline{toc}{section}{Continuous Data - Histograms}
...
\addcontentsline{toc}{section}{Categorical Data}
...
\caption{the ipums logo}\label{fig:unnamed-chunk-51}
\end{figure}
