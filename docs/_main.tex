...
\addcontentsline{toc}{subsection}{Unit 2 Finding Data and Asking Questions}

Here we demonstrate two \textbf{different} approaches to conducting research.

\hypertarget{exploratory-analysis}{%
\subsubsection*{Exploratory Analysis}\label{exploratory-analysis}}
\addcontentsline{toc}{subsubsection}{Exploratory Analysis}
...
\addcontentsline{toc}{subsubsection}{Hypotethsis Driven}
