...
Open-source and customizable - all materials available on \href{https://github.com/ehrlichd/stats_book}{Github}

Made with open-source tools - \href{https://cran.r-project.org/}{R}, \href{https://www.rstudio.com/products/rstudio/}{RStudio}, \href{https://bookdown.org/}{bookdown}

Driven by (nearly) open-source data, harmonized across time and space. - \href{https://ipums.org}{IPUMS}
...
\begin{verbatim}
##   [1] 10.640003 11.335477 10.696800  7.940991  9.378810 11.158938 10.358443
##   [8]  9.335207  9.913354 10.364507 11.111284  9.663179  8.460345 11.059331
##  [15]  9.390150  9.886510  8.394740 10.707587  9.944541  9.756610 13.066961
##  [22]  9.610115  8.928899  9.370855  9.604840  8.684002 10.818371  9.947986
##  [29]  8.644595 10.121559  9.466146 10.234926 12.193999  9.816538  9.745556
##  [36] 10.431175  9.373200  9.557036  9.427267  8.374522 10.253828  9.932229
##  [43] 10.747812  9.428121 11.747044  7.131683 12.144114  9.958145  8.517905
##  [50] 10.009615  9.000682 10.860729  8.361770 11.716648 10.235285  9.003695
##  [57]  8.619146 10.409840 10.243579  9.910568  9.586047  9.488099 12.452762
##  [64] 10.168890 10.113520  7.637835 10.561608  9.863173 10.760441 10.628929
##  [71]  9.818885  9.002237 11.341899  8.743655  9.827232  8.299759 11.125096
##  [78] 10.085853 10.564645 11.294765 10.394312  9.303190 11.580541  9.750376
##  [85] 11.072313  9.471482 10.105742  9.004619 10.476570 10.636434  9.207190
##  [92] 11.497606  8.482294  9.619367 10.630094 10.295705 10.256195 12.181595
##  [99]  8.914229 11.631316
\end{verbatim}
...
##   7.132   9.377   9.946  10.010  10.637  13.067
\end{verbatim}
...
\begin{verbatim}
##           Min.  1st Qu.    Median      Mean   3rd Qu.     Max.
## [1,]  70.21137 93.21291 100.35383 100.12214 106.73892 138.5635
## [2,] -21.11075 42.98612  59.61846  58.66419  75.57238 139.9773
\end{verbatim}
...
\hline
  & Min. & 1st Qu. & Median & Mean & 3rd Qu. & Max.\\
\hline
data1 & 70.21137 & 93.21291 & 100.35383 & 100.12214 & 106.73892 & 138.5635\\
\hline
data2 & -21.11075 & 42.98612 & 59.61846 & 58.66419 & 75.57238 & 139.9773\\
\hline
\end{tabular}
...
\NormalTok{d2 <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(YEAR }\OperatorTok{%in%}\StringTok{ }\NormalTok{census_years)}
...
\NormalTok{hhs <-}\StringTok{ }\NormalTok{d2 }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\NormalTok{RELATE }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{) }\OperatorTok{|}
\StringTok{                  }\NormalTok{(RELATE }\OperatorTok{==}\StringTok{ }\DecValTok{3} \OperatorTok{&}
\StringTok{                     }\NormalTok{MARST }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{4}\NormalTok{))}
